import {FaFacebook, FaLinkedinIn, FaInstagram, FaTwitter, FaYoutube} from 'react-icons/fa'

const Footer = () => {
  return (
    <div className="mt-8 bg-[#003366] pt-9">
    <div className="mx-auto w-full max-w-[1166px] px-4 xl:px-0">
      <div className="flex flex-col justify-between sm:px-[18px] md:flex-row md:px-10">
        <div className="md:w-[316px]">
          <div className="text-[18px] font-medium text-white">
          <h1 className="text-white font-extrabold">
            <span className="text-rose-600">Zanzan</span>LOGO
          </h1>
          </div>
          ...
          <div className=" text-white mt-[18px] flex gap-4">
            <FaFacebook/>
            <FaLinkedinIn/>
            <FaInstagram/>
            <FaTwitter/>
        ...
        <div className="mt-6 flex w-full flex-col justify-between text-white sm:flex-row md:mt-0 md:max-w-[341px]">
          ...
          <div className="mt-6 flex flex-col gap-4 sm:mt-0">
           <button className=" bg-white rounded p-2 text-indigo-600 font-bold">Volunteer</button>
           <button className="bg-white rounded p-2 text-indigo-600 font-bold">Donate</button>
      ...
      <div className="flex items-center justify-center pb-8 pt-[9px] md:py-8">
        <p className="text-[10px] font-normal text-white md:text-[12px]">
          ...
          , All Rights Reserved by Zanzan.org
        </p>
      </div>
    </div>
  </div>
